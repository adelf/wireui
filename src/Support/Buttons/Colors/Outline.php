...
{
    private string $hover = 'focus:border-transparent dark:focus:border-transparent dark:focus:bg-slate-700 dark:focus:ring-offset-slate-800';

    private string $focus = 'dark:hover:bg-slate-700';
    ...
    public function all(): array
    {
        return [
            'primary' => new Color(
                ...
                hover: "{$this->hover} hover:text-primary-500 hover:bg-primary-50",
            ...
            'positive' => new Color(
                ...
                hover: "{$this->hover} hover:text-positive-500 hover:bg-positive-50",
            ...
            'negative' => new Color(
                ...
                hover: "{$this->hover} hover:text-negative-500 hover:bg-negative-50",
            ...
            'warning' => new Color(
                ...
                hover: "{$this->hover} hover:text-warning-500 hover:bg-warning-50",
            ...
            'info' => new Color(
                ...
                hover: "{$this->hover} hover:text-info-500 hover:bg-info-50",
            ...
            'dark' => new Color(
                ...
                hover: "{$this->hover} hover:text-slate-600 dark:hover:text-slate-400 hover:bg-slate-200",
            ...
            'white' => new Color(
                ...
                hover: "{$this->hover} hover:text-slate-500 dark:hover:text-slate-200 hover:bg-slate-100",
            ...
            'black' => new Color(
                ...
                hover: "{$this->hover} hover:text-black dark:hover:text-slate-200 hover:bg-slate-100",
            ...
            'gray' => new Color(
                ...
                hover: "{$this->hover} hover:text-gray-500 dark:hover:text-gray-400 hover:bg-gray-100",
            ...
            'zinc' => new Color(
                ...
                hover: "{$this->hover} hover:text-zinc-500 dark:hover:text-zinc-400 hover:bg-zinc-100",
            ...
            'neutral' => new Color(
                ...
                hover: "{$this->hover} hover:text-neutral-500 dark:hover:text-neutral-400 hover:bg-neutral-100",
            ...
            'stone' => new Color(
                ...
                hover: "{$this->hover} hover:text-stone-500 dark:hover:text-stone-400 hover:bg-stone-100",
            ...
            'red' => new Color(
                ...
                hover: "{$this->hover} hover:text-red-500 dark:hover:text-red-400 hover:bg-red-50",
            ...
            'orange' => new Color(
                ...
                hover: "{$this->hover} hover:text-orange-500 dark:hover:text-orange-400 hover:bg-orange-50",
            ...
            'amber' => new Color(
                ...
                hover: "{$this->hover} hover:text-amber-500 dark:hover:text-amber-400 hover:bg-amber-50",
            ...
            'lime' => new Color(
                ...
                hover: "{$this->hover} hover:text-lime-500 dark:hover:text-lime-400 hover:bg-lime-50",
            ...
            'green' => new Color(
                ...
                hover: "{$this->hover} hover:text-green-500 dark:hover:text-green-400 hover:bg-green-50",
            ...
            'emerald' => new Color(
                ...
                hover: "{$this->hover} hover:text-emerald-500 dark:hover:text-emerald-400 hover:bg-emerald-50",
            ...
            'teal' => new Color(
                ...
                hover: "{$this->hover} hover:text-teal-500 dark:hover:text-teal-400 hover:bg-teal-50",
            ...
            'cyan' => new Color(
                ...
                hover: "{$this->hover} hover:text-cyan-500 dark:hover:text-cyan-400 hover:bg-cyan-50",
            ...
            'sky' => new Color(
                ...
                hover: "{$this->hover} hover:text-sky-500 dark:hover:text-sky-400 hover:bg-sky-50",
            ...
            'blue' => new Color(
                ...
                hover: "{$this->hover} hover:text-blue-500 dark:hover:text-blue-400 hover:bg-blue-50",
            ...
            'indigo' => new Color(
                ...
                hover: "{$this->hover} hover:text-indigo-500 dark:hover:text-indigo-400 hover:bg-indigo-50",
            ...
            'violet' => new Color(
                ...
                hover: "{$this->hover} hover:text-violet-500 dark:hover:text-violet-400 hover:bg-violet-50",
            ...
            'purple' => new Color(
                ...
                hover: "{$this->hover} hover:text-purple-500 dark:hover:text-purple-400 hover:bg-purple-50",
            ...
            'fuchsia' => new Color(
                ...
                hover: "{$this->hover} hover:text-fuchsia-500 dark:hover:text-fuchsia-400 hover:bg-fuchsia-50",
            ...
            'pink' => new Color(
                ...
                hover: "{$this->hover} hover:text-pink-500 dark:hover:text-pink-400 hover:bg-pink-50",
            ...
            'rose' => new Color(
                ...
                hover: "{$this->hover} hover:text-rose-500 dark:hover:text-rose-400 hover:bg-rose-50",
                focus: "{$this->focus} focus:text-rose-500 focus:ring-rose-500 focus:bg-rose-50 dark:focus:text-rose-400",
            ),
        ];
    }
}
